...
$cuantos_tabla = Usuarios::cuantosRegistros();
$por_pagina = 100;
...
<body>
   ...
   <div class="container">
      ...
      <tbody>
				...
				if (COUNT($registros)>0) {
					for ($i=0; $i < COUNT($registros) ; $i++) {
						$id = $registros[$i][0];
						//$nombre = $registros[$i][1]." ".$registros[$i][2];
						$mail = $registros[$i][1];
						//$estado = $registros[$i][7];
						$dia = $registros[$i][3];
						$guias = Guias::guiasusuarios($mail);
	...
	<ul class="pagination">
    <li class="waves-effect"><a href="registros.php?pagina=<?php echo $pagination['pagina_anterior'] ?>"><i class="material-icons">chevron_left</i></a></li>
		<?php
		for ($i=0; $i < $pagination['total_paginas']; $i++) {
			...
			echo'<li '.$active.'><a href="registros.php?pagina='.$actual.'">'.$actual.'</a></li>';
		}
		?>

    <li class="waves-effect"><a href="registros.php?pagina=<?php echo $pagination['pagina_siguiente'] ?>"><i class="material-icons">chevron_right</i></a></li>
  </ul>
