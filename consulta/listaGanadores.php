...
<body>
   ...
   <div class="container">
      ...
      <tbody>
				...
				if (COUNT($registros)>0) {
					for ($i=0; $i < COUNT($registros) ; $i++) {
						...
						$premio = utf8_encode($registros[$i][7]);
	...
	<ul class="pagination">
    <li class="waves-effect"><a href="listaGanadores.php?dia=<?php echo $dia; ?>&pagina=<?php echo $pagination['pagina_anterior'] ?>"><i class="material-icons">chevron_left</i></a></li>
		<?php
		for ($i=0; $i < $pagination['total_paginas']; $i++) {
			...
			echo'<li '.$active.'><a href="listaGanadores.php?dia='.$dia.'&pagina='.$actual.'">'.$actual.'</a></li>';
		}
		?>

    <li class="waves-effect"><a href="listaGanadores.php?dia=<?php echo $dia; ?>&pagina=<?php echo $pagination['pagina_siguiente'] ?>"><i class="material-icons">chevron_right</i></a></li>
  </ul>
